    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/10 backdrop-blur-sm animate-fade-in">
      <div className="w-full max-w-[400px] bg-white border border-[#e5e5e7] rounded-3xl p-8 shadow-[0_30px_70px_rgba(0,0,0,0.08)] relative animate-scale-in">
        ...
        <div className="flex flex-col items-center text-center mt-2 mb-6">
          <div className="w-12 h-12 rounded-full bg-[#fdf2f2] flex items-center justify-center text-[#e02424] mb-4">
          ...
          <p className="text-xs text-[#737373] tracking-wide leading-relaxed max-w-[280px]">
            Are you sure you want to leave <span className="font-semibold text-black">"{projectName || "this project"}"</span>? You will lose access until the owner invites you again.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2.5">
          <Button
            ...
            onClick={onConfirm}
            isLoading={isPending}
            className="w-full bg-[#e02424] hover:bg-[#c81e1e] text-white"
          >
            Leave Project
          </Button>
          <Button
